...
void init()
{
	...
	//mapClass.addJunction(Junction::Junction("S", 0, 0, glm::mat4(1.0f), RoadType::S),1,0);
	//mapClass.getMapJunction(1, 0)->setOrientation(0);
	//mapClass.getMapJunction(1, 0)->setSpawnable(false, 0);
